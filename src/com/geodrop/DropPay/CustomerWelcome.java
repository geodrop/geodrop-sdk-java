 ...
 *
 */
public class CustomerWelcome extends GeodropRequest 
{
	/**
	 * DropPay port number
	 */
	 ...
	 */
	public CustomerWelcome(int port,String msisdn,String text,int order,String pin,String custom) throws Exception
	{
		this.initialize(port, msisdn, text, order, pin, custom);
	}
	 ...
	 * @throws Exception If parameters are not valid
	 */
	public CustomerWelcome(int port,String msisdn,String text,int order,String pin) throws Exception
	{
		this.initialize(port, msisdn, text, order, pin, "customFromSDK");
	}
	 ...
	 * @throws Exception If parameters are not valid
	 */
	public CustomerWelcome(int port,String msisdn,String text,int order) throws Exception
	{
		this.initialize(port, msisdn, text, order, null, "customFromSDK");
	}
	...
	//setters
	/**
	 * @param port DropPay port number
	 */
