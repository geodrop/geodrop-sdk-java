...
public final class Uri 
{
	...
	public static final String PAY_CUSTOMERS_GOODBYE   = "https://api.geodrop.net/pay/2/customers/goodbye/1/";
	public static final String PAY_CUSTOMERS_WELCOME   = "https://api.geodrop.net/pay/2/customers/welcome/1/";
	public static final String PAY_PORT_CHALLENGE      = "https://api.geodrop.net/pay/2/port/challenge/1/";
	public static final String PAY_PORT_CHARGE         = "https://api.geodrop.net/pay/2/port/charge/1/";
	public static final String PAY_PORT_DESCRIPTOR     = "https://api.geodrop.net/pay/2/port/descriptor/1/";
	public static final String PAY_PORT_TRIGGER        = "https://api.geodrop.net/pay/2/port/trigger/1/";
